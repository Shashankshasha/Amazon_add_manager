...
| Amazon Developer identity verification | **Blocked** | First attempt failed; resolve before depending on this account for API onboarding. See the plan's Phase 5.1. |
| Login with Amazon security profile | **Not started — manual step** | `docs/01-security-profile-setup.md` |
...
1. **Manual, in-browser:** work through
   ...
   profile) and report back what Amazon's console still permits given
   the identity-verification failure.
